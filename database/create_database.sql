...
CREATE TABLE course_sections (
    ...
    capacity INTEGER DEFAULT 30 CHECK (capacity <= 30),
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (course_id) REFERENCES courses(id),
    ...
    UNIQUE(teacher_id, semester_id, time_slot_id),
    -- Prevent double booking a room
    UNIQUE(classroom_id, semester_id, time_slot_id)
);

-- Table 11: Enrollments (Active Semester)
